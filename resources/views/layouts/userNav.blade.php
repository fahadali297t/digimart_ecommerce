...
<nav class="w-full  lg:mt-0 px-5 z-50 sticky bg-white top-0 left-0  flex justify-between items-center">
    ...
    <div class=" hidden  lg:flex justify-center items-center  gap-10">
        ...
        @endphp
        <a href="{{ route('wishlist') }}" class=" relative hover:cursor-pointer font-normal ">
            <span
                class="absolute text-xs font-semibold bg-black text-white -top-3 -right-3  w-5 flex justify-center items-center overflow-hidden  h-5 rounded-full">{{ $wishCount }}</span>
        ...
        <a href="{{ route('cart') }}" class=" relative hover:cursor-pointer font-normal ">
            <span
                class="absolute text-xs font-semibold bg-black text-white -top-3 -right-3  w-5 flex justify-center items-center overflow-hidden  h-5 rounded-full">{{ $cartCount }}</span>
