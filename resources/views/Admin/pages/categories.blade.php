                                        ...
                                        <tbody>
                                            ...
                                            @forelse ($categs as $cat)
                                                <tr>
                                                    ...
                                                    <td><a href="{{ route('admin.category.view', $cat->id) }}"
                                                            class="text-reset" tabindex="-1">{{ $cat->name }}</a></td>
                                                    <td>
                                                        <img width="100px" height="100px" style="object-fit: cover"
                                                            src="{{ asset('storage/uploads/' . $cat->img) }}" alt="img"
                                                            srcset="">
                                                    </td>
                                                    <td>
                                                        <span class="d-none">
                                                        ...
                                                        <span class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <a class="dropdown-item"
                                                                    href="{{ route('admin.category.view', $cat->id) }}">
