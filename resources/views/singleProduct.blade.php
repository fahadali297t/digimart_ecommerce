                ...
                <div class="lg:col-span-7 px-5 flex flex-col gap-6">
                    ...
                    <div class="flex flex-wrap gap-4 mt-6">
                        ...
                        <form action="{{ route('addwish') }}" method="POST" class="w-full sm:w-auto flex">
                            ...
                            <input type="hidden" name="pid" value="{{ $product->id }}">
                            <button type="submit"
                                class="flex items-center justify-center px-6 py-3 text-black bg-white hover:bg-black hover:text-white rounded-lg border-2 border-black text-lg transition">
